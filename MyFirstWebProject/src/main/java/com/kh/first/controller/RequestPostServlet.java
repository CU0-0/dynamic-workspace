...
public class RequestPostServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 나머지 input요소 값들도 getParameter 또는 getParameterValue메소드를 호출해서 받아와서 변수에 대입 한 뒤
		// 콘솔창에 출력하기 시작!
		...
		//-------------------------------------------
		// 음답화면(JSP)에서 필요한 데이터를 넘겨줄 것(request에 담아서)
		// attribute => 키 - 밸류 세스톨 묶어서 값을 담을 수 있음
		// request.setAttribute("7l", ""#");
		// Object o = 1;
		...
		request.setAttribute("msg", "성공 추카포카");
