...
public class BoardInsertController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(ServletFileUpload.isMultipartContent(request)) {
			 ...
			 * 
			 * 	1Byte X 1024 => 1KByte
			 * 1KByte X 1024 => 1MByte
			 * 1MByte X 1024 => 1GByte
			 * 1GByte X 1024 => 1TByte
			 * 1TByte X 1024 => 1PByte
			 * 
			 * 10MegaByte
			 */
			...
			// a.jpg  a2.jpg  a3.jpg
			// KakoTalk_ 20260511_173604 123.jpg
			/*
			 * HttpServletRequest
			 * 
			 * =>
			 ...
			 * new MultiRequest(request, 저장경로, 용량제한, 인코딩방식, 파일명을 수정해주는 rename메소드를 가지고있는객체);
			 * 
			 * 생성자를 호출하면 자동으로 파일이 업로드
			 * 
			 * 일반적으로 파일의 경우 반드시 파일명을 변경해서 업로드하는것이 관례
			 * 
