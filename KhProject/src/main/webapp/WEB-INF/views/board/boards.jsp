   	...
   	<div class="container">
      	<div class="row">
	        ...
	        <h2 class="page-header"><span style="color: #52b1ff;">KH</span> 자유 게시판
	        	<a href="http://localhost:8088/kh/insertfrom.bo" class="btn float-right" style="background-color: #52b1ff; margin-top: 0; height: 40px; color: white; border: 0px solid #f78f24; opacity: 0.8">글쓰기</a>
            </h2>
			...
			<c:choose>
           		<c:when test="${ empty boards }">
           			<tr>
           				<th colspan="3">조회 결과가 존재하지 않습니다 .</th>
           			</tr>
           		</c:when>
	       		<c:otherwise>
